...
def test_BitMexKlineTransform_from_scratch() -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        with pandas.HDFStore(os.path.join(tmp, 'kline.hdf')) as store:
            ...
            assert ETHUSD.index[0] == utc_datetime(2018, 1, 1, 12, 1)
            ...
            assert ETHUSD.index[1] == utc_datetime(2018, 1, 1, 12, 2)
            ...
            assert ETHUSD.index[2] == utc_datetime(2018, 1, 1, 12, 3)
            ...
            assert ETHUSD.index[3] == utc_datetime(2018, 1, 2, 12, 1)
            ...
            assert ETHUSD.index[4] == utc_datetime(2018, 1, 2, 12, 2)
            ...
            assert ETHUSD.index[5] == utc_datetime(2018, 1, 2, 12, 3)
...
def test_BitMexKlineTransform_with_data() -> None:
    with tempfile.TemporaryDirectory() as tmp_input:
        ...
        with pandas.HDFStore(kline_hdf) as store:
            ...
            assert ETHUSD.index[-2] == utc_datetime(2018, 1, 2, 12, 2)
            ...
            assert ETHUSD.index[-1] == utc_datetime(2018, 1, 2, 12, 3)
